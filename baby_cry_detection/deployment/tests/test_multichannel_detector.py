...
# This file lives in deployment/tests/ — go up one level for local modules,
# two levels for baby_cry_detection/ (src.* transitive imports).
...
# Local deployment modules (in parent directory)
...
def test_channel_selection():
    ...
    class MockDetector:
        ...
        def detect_cry(self, audio, use_tta=False):
            ...
            return is_cry, confidence, False
