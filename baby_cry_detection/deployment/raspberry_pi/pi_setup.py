...
ExecStart={sys.executable} deployment/raspberry_pi/realtime_baby_cry_detector.py --model deployment/calibrated_model.pth
Restart=always
RestartSec=10
...
def main():
    ...
    if args.all:
        print("\nPi setup complete!")
        print("Run 'python deployment/raspberry_pi/realtime_baby_cry_detector.py --model <model_path>' to start detection")
