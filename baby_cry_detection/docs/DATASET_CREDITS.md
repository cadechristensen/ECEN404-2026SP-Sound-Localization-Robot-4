...
- **Files Used**:
  - ~140 baby non-cry sounds in `data/hard_negatives/baby_noncry/` (original collection)
  - ~50 adult scream sounds in `data/hard_negatives/adult_scream/` (original collection)
  - Phase 2 expansion (February 2026): +302 baby non-cry, +50 adult scream via [[Sound-Localization-Claude/baby_cry_detection/scripts/download_freesound.py|scripts/download_freesound.py]]
- **License**: Various Creative Commons licenses (individual files retain original licenses)
- **Description**: Community-contributed audio used as hard negatives for false positive reduction
- **Attribution**: Individual file attributions below
- **API Documentation**: https://freesound.org/docs/api/
- **Download Script**: [[Sound-Localization-Claude/baby_cry_detection/scripts/download_freesound.py|scripts/download_freesound.py]] (requires API key from https://freesound.org/apiv2/apply)
- **Search Terms Used**:
  - Baby non-cry: baby babbling, infant babble, baby talking, baby vocalization, baby sounds happy, baby laughing, baby giggle, infant laugh, toddler laughing, baby cooing, infant cooing, baby coo, baby gurgle, toddler talking, toddler speech, child babbling
  - Adult scream: woman scream, female scream high pitch, girl screaming, woman shriek, child scream, kid screaming, toddler scream
...
To view individual file credits and licenses, visit: `https://freesound.org/s/[ID]/`

**Example files and their creators:**
- freesound_139046_Babbling - Happy 2.ogg - User: [View on Freesound](https://freesound.org/s/139046/)
- freesound_416639_Baby Gibberish 4wav.ogg - User: [View on Freesound](https://freesound.org/s/416639/)
- freesound_458645_babygigglemp3.ogg - User: [View on Freesound](https://freesound.org/s/458645/)
...
**Total Training Samples: ~8,695** (raw); **~8,680 used** after filtering (consolidated dataset structure)

| Directory      | Files  | Label               | Source                          | Description                                                           |
| -------------- | ------ | ------------------- | ------------------------------- | --------------------------------------------------------------------- |
| cry_baby       | ~3,928 | cry                 | Multiple sources (consolidated) | All baby cry recordings from Donate-a-Cry, ICSD, CryCeleb, HF, Kaggle |
| hard_negatives | ~4,767 | non_cry             | Multiple sources (consolidated) | All non-cry sounds: baby sounds, adult speech, environmental          |
| noise          | ~1,960 | (augmentation only) | ESC-50                          | Background noise for augmentation                                     |

**Class Balance: ~3,928 cry / ~4,767 non-cry (~0.83:1 ratio - well-balanced)**
...
- **October 2025 Additions**:
  ...
  - Total cry samples increased: 696 -> ~4,505 (+547%)
  - Reduced adult_speech: 4,481 -> 2,241 (50% reduction for better balance)
  - Added additional environmental sounds
  - Class imbalance improved: 1:9.77 -> ~0.96:1 (well-balanced)
  - Added .3gp and .mp3 format support
  - All cry samples are real recordings (no synthetic audio)
- **November 2025 Consolidation**:
  - Created cry_baby directory (~4,505 files) consolidating all cry sources
  - Created hard_negatives directory (~4,707 files) consolidating all non-cry sources
  - Total dataset: ~9,212 samples (~4,505 cry + ~4,707 non-cry)
  - Class balance: ~0.96:1 (cry:non-cry) - well-balanced
  - Legacy directories (cry, cry_ICSD, cry_crycaleb, baby_noncry, adult_speech, environmental) archived for reference
- **February 2026 Phase 2 Expansion (hard negatives)**:
  - Expanded baby_noncry: +302 samples via Freesound API (babbling, laughing, cooing, toddler speech)
  - Expanded adult_scream: +50 samples via Freesound API (female screams, children's screams)
  - Motivation: /assess graded model C with 59 FPs — baby_noncry (12 FPs) and adult_scream (4 FPs) were top offenders
  - Download script: [[Sound-Localization-Claude/baby_cry_detection/scripts/download_freesound.py|scripts/download_freesound.py]]
  - Total hard_negatives after expansion: ~5,059 samples
  - Updated class balance: ~0.89:1 (cry:non-cry)
- **March 2026 Filtering (Run 16 - train_2026-03-14_20-11-56)**:
  ...
  - Total raw: ~8,695; used in training: ~8,680
  - Final cry samples: ~3,928 (represents filtering applied to Phase 2 expanded dataset)
  - Final non-cry samples: ~4,767 (represents filtering applied to Phase 2 expanded dataset)
  - Updated class balance: ~0.83:1 (cry:non-cry) - well-balanced
  - Dataset splits (stratified): Train 5,208 (2,851 non-cry + 2,357 cry), Val 1,736 (951 non-cry + 785 cry), Test 1,736 (950 non-cry + 786 cry)
...
- **November 2025**: Consolidated all cry samples into cry_baby, all non-cry into hard_negatives
